...
const { updateSummaryFromSystemData } = require("./summary");
...
async function updateMyvDevices(adapter) {
    ...
    for (const device of adapter.deviceArray) {
        ...
        try {
            ...
            await updateSummaryFromSystemData(adapter, id, res.data);
        } catch (error) {
